...
<input type="hidden" name="qna_nono" value="${viewQna.qna_no }" />

<table class="table table-bordered">
<tr><td class="info">아이디</td><td>${account.account_email }</td></tr>
<tr><td class="info">닉네임</td><td>${account.account_nick }</td></tr>
<tr><td class="info">제목</td><td><input type="text" name="title" style="width:100%" value="${viewQna.qna_title }"/></td></tr>
<tr><td class="info" colspan="2">본문</td></tr>
<tr><td colspan="2">
	<textarea id="content" name="content" rows="10" cols="100">${viewQna.qna_content }</textarea>
</td></tr>
</table>

<label>기존 첨부파일 : </label>${qnaFile.originName }<br>

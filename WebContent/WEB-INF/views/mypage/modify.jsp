	...
	<div class="col-lg-6">
		<div class="jumbotron padding" style="background-color: #FFF2EC" >
			<form name="loginInfo" method="post" action="/account/update" onsubmit="Freturn checkValue()">
				...
				<div class="form-group">
					<input type="password" class="form-control font-gothic" placeholder="새로운 비밀번호확인" onkeyup="pwCheckFunction();" name="account_pw2" id="account_pw2" maxlength="50"/>
				<h5 style="color: red;" id="pwCheckMessage"></h5> 
				</div>
				<div class="form-group">
					<div class="form-inline" >
						<input type="text" class="form-control font-gothic" style="width: 330px;" placeholder="새로운 닉네임" name="account_nick" id="account_nick" maxlength="50"/>
				...
				<div class="form-group">
					<input type="submit" class="btn btn-primory form-control input color font-gothic"  value="회원 정보 수정하기" />

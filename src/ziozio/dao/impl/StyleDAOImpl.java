...
//				
//				style.setStyle_code(rs.getInt(style.getStyle_code()));
//				style.setStyle_name(rs.getString(style.getStyle_name()));
//				style.setCloth_category_name(rs.getString(style.getCloth_category_name()));
//				style.setCloth_name(rs.getString(style.getCloth_name()));
//				style.setColor_name(rs.getString(style.getColor_name()));				
//
//				list.add(style);
//			}
